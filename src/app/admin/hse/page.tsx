...
export default function HSEDashboardPage() {
  ...
  const pieData =
    s?.hazardDist.slice(0, 6).map((d, i) => ({
      ...
      <div className="space-y-6 pb-8">
        ...
        <div>
          <div className="flex items-center gap-3 mb-1">
            ...
            <h1 className="text-white text-2xl font-bold">Dashboard EHS</h1>
          </div>
          <p className="text-gray-400 text-sm mt-1">
            Analitik laporan kunjungan EHS
          </p>
        </div>
        ...
        {loading ? (
          ...
          <>
            ...
            <div className="card-dark p-4">
              <SectionTitle
                icon={BarChart2}
                title={`Laporan EHS – ${PERIOD_LABELS[period]}`}
              />
            ...
            {s.findingsTrend &&
              s.findingsTrend.some((d) => d.findings + d.clear > 0) && (
                <div className="card-dark p-4">
                  <SectionTitle
                    icon={Activity}
                    title={`Tren Kunjungan EHS – ${PERIOD_LABELS[period]}`}
            ...
            {s.peakHours && s.peakHours.some((h) => h.count > 0) && (
              <div className="card-dark p-4">
                <SectionTitle
                  icon={Clock}
                  title={`Distribusi Jam Kunjungan EHS – ${PERIOD_LABELS[period]}`}
                  sub="Kapan laporan EHS paling sering masuk"
                />
